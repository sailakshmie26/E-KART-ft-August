  ...
  return (
    <>
        <button className='btn btn-success mt-4 ms-4'>
          <Link to={'/'} style={{textDecoration:'none', color:'white'}}><i class="fa-solid fa-arrow-left me-2"></i>BACK TO HOME</Link>
        </button>
     <Row className='m-5'>
      ...
      <Card.Body>
       ...
       <div style={{height:'100vh'}} className='d-flex align-items-center flex-column'>
        <img src="https://www.harshcreation.com/images/emptywishlist.jpg" alt="" height="300px"/>
        <h3 className='fw-bolder' style={{color:'#ff8c1a'}}>your wishlist is empty!!</h3>
       </div>
